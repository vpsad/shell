...
GetSysInfo(){
	...
	echo -e ${SYS_INFO}
	echo -e "请截图以上报错信息加QQ群：613980114求助"
}
Red_Error(){
	echo '=================================================';
...
get_node_url(){
	...
	download2_Url=https://www.05bt.com
...
Install_Bt(){
	...
	wget -O panel.zip ${download2_Url}/install/src/panel6.zip -T 10
...
+----------------------------------------------------------------------
| VPS博客 | www.vpsad.cn | QQ交流群：613980114 | 欢迎各位
+----------------------------------------------------------------------
"
while [ "$go" != 'y' ] && [ "$go" != 'n' ]
do
...
echo -e "\033[33m VPS博客 | www.vpsad.cn | QQ群：613980114 \033[0m"
